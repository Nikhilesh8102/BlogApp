...
function Signup() {
    ...
    return (
        <div className='flex items-center justify-center m-2 mt-20 p-2'>
            <div className={`mx-auto w-full max-w-lg bg-[#B0A695] rounded-xl p-10 border border-black/10`}>
                ...
                <form onSubmit={handleSubmit(create)}>
                    <div className='space-y-3 mt-4 text-left text-white'>
                        ...
                        <Button
                            type="submit"
                            className="w-full text-black bg-green-500 mt-4 py-2 font-semibold hover:text-black"
